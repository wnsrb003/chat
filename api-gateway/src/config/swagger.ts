...
`,
    ...
    tags: [
      ...
      },
      {
        name: "WebSocket",
        description:
          "WebSocket API for real-time translation (see description above for details)",
      },
    ],
    components: {
      schemas: {
            ...
            options: {
              ...
              properties: {
                expandAbbreviations: {
                  type: "boolean",
                  description:
                    "Expand Korean abbreviations (e.g., ㅇㅇ → 응응)",
                  default: true,
                },
                filterProfanity: {
                  type: "boolean",
                ...
                normalizeRepeats: {
                  type: "boolean",
                  description:
                    "Normalize repeated characters (e.g., ㅋㅋㅋㅋㅋ → ㅋㅋ)",
                  default: true,
                },
                removeEmoticons: {
                  type: "boolean",
